...
def test_schema_four_manifest_is_the_current_release_authority() -> None:
    ...
    assert manifest["completed_control_plane_change"]["number"] == 5
    ...
    assert manifest["automated_validation"]["pr_head_ci"]["run_id"] == "30151090974"
...
def test_generated_current_status_is_the_only_volatile_document_surface() -> None:
    ...
    assert "PR #5" in current_status
    assert "30151090974" in current_status
