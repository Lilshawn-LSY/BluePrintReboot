...
REQUIRED_FILES = (
    ...
    "services/paper_removal.py",
    "services/tag_governance.py",
    "services/tag_candidate_review.py",
    "services/tag_candidate_quality.py",
    "storage/tag_candidate_review_store.py",
    "requirements.txt",
    "README.md",
    ...
    "frontend/app/views/TagsView.tsx",
    ...
    "ingest/pdf_inspector_adapter.py",
...
def check_api_contract() -> SmokeCheckResult:
    try:
        ...
        expected_methods = {
            ...
            "/papers/upload": {"post"},
            "/papers/{paper_id}": {"get"},
            "/papers/{paper_id}/reading-status": {"patch"},
            "/papers/{paper_id}/remove-pdf": {"post"},
            "/papers/{paper_id}/archive": {"post"},
            ...
            "/papers/{paper_id}/tag-candidates": {"get"},
            "/papers/{paper_id}/tag-candidates/generate": {"post"},
            "/papers/{paper_id}/tag-candidates/{candidate_id}/approve": {"post"},
            "/papers/{paper_id}/tag-candidates/{candidate_id}/reject": {"post"},
            "/papers/{paper_id}/tag-candidates/{candidate_id}/promote": {"post"},
            "/papers/{paper_id}/tag-candidates/{candidate_id}/apply": {"post"},
            ...
            "/tags": {"get", "post"},
            "/tags/summary": {"get"},
            "/tags/review-queue": {"get"},
            "/tags/governance": {"get"},
            "/tags/{canonical_key}": {"patch"},
            "/tags/{canonical_key}/aliases": {"post", "delete"},
            "/tags/{canonical_key}/deprecate": {"post"},
...
def check_frontend_contract(project_root: Path) -> SmokeCheckResult:
    try:
        ...
        for method in (
            ...
            "createCanonicalTag",
            "updateCanonicalTag",
            "addCanonicalTagAlias",
            "removeCanonicalTagAlias",
            "deprecateCanonicalTag",
            "getSettingsSummary",
            "saveReaderMetadata",
            "saveReadingStatus",
