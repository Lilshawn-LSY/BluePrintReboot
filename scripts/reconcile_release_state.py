...
def validate_manifest(manifest: Mapping[str, Any]) -> None:
    ...
    if manifest.get("product_version") != "1.6.6":
        raise ReleaseStateError("product_version must identify the current 1.6.6 runtime target")
    if manifest.get("release_name") != "v1.6.6-task-first-ux-redesign":
        raise ReleaseStateError("release_name must identify the current v1.6.6 runtime target")
